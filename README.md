...
A web-based system for managing laboratory equipment borrowing, maintenance, and service requests, with role-based access for Administrators, Laboratory Staff, and Requesters. Built as a Systems Analysis and Design (SAD) project.

**Live Demo:** [jayian30.github.io/Laboratory-Asset-and-Service-Management-System](https://jayian30.github.io/Laboratory-Asset-and-Service-Management-System/)
...
| Role | Description |
|---|---|
| **Administrator** | Full access — manages equipment, users, approves/rejects requests, views audit logs |
| **Laboratory Staff** | Manages equipment, releases/returns borrowed items, handles maintenance |
| **Requester** | Browses available equipment, submits borrowing requests, views own history |
